...
//BENCHMARK(OrderedMap_Insertion)->RangeMultiplier(2)->Range(8, 8 << 8)->MinWarmUpTime(1)->Iterations(8 << 14);
...
//
//BENCHMARK(SkipList_Insertion)->RangeMultiplier(2)->Range(8, 8 << 8)->MinWarmUpTime(1)->Iterations(8 << 14);
...
//
//BENCHMARK(OrderedMap_Search)->RangeMultiplier(2)->Range(8, 8 << 8)->MinWarmUpTime(1)->Iterations(8 << 14);
...
//
//BENCHMARK(SkipList_Search)->RangeMultiplier(2)->Range(8, 8 << 8)->MinWarmUpTime(1)->Iterations(8 << 14);
